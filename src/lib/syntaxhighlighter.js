 ...
 *
 * @version
 * 4.0.1 (Sat, 01 Jul 2017 04:30:36 GMT)
 *
 * @copyright
...
/** */ (function (module, exports, __webpack_require__) {
    ...
    const _core = __webpack_require__(1)

    Object.keys(_core).forEach((key) => {
    ...
    const _domready = __webpack_require__(52)

    const _domready2 = _interopRequireDefault(_domready)

    const _core2 = _interopRequireDefault(_core)

    const _dasherize = __webpack_require__(53)

    const dasherize = _interopRequireWildcard(_dasherize)
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    let optsParser = __webpack_require__(2),
    ...
    function findBrush(alias, showAlert) {
	  ...
	  if (brushes == null) {
	    ...
	    // Find all brushes
	    for (const brushName in sh.brushes) {
	      let brush = sh.brushes[brushName],
    ...
    exports.default = sh
    const registerBrush = exports.registerBrush = function registerBrush(brush) {
	  return sh.brushes[`brush${brushCounter++}`] = brush.default || brush
    }
    const clearRegisteredBrushes = exports.clearRegisteredBrushes = function clearRegisteredBrushes() {
	  sh.brushes = {}
	  brushCounter = 0
    }
  ...
  /* 2 */
  /** */ (function (module, exports, __webpack_require__) {
    const XRegExp = __webpack_require__(3).XRegExp

    const BOOLEANS = { true: true, false: false }

    function camelize(key) {
	  return key.replace(/-(\w+)/g, (match, word) => {
	  ...
	  parse: function parse(str) {
	    ...
	    while ((match = XRegExp.exec(str, regex, pos)) != null) {
	      ...
	      if (value != null && arrayRegex.test(value)) {
	        const m = XRegExp.exec(value, arrayRegex)
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _xregexp = __webpack_require__(4)

    const _xregexp2 = _interopRequireDefault(_xregexp)

    function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj } }

    exports.XRegExp = _xregexp2.default
    const commonRegExp = exports.commonRegExp = {
  ...
  /** */ (function (module, exports) {
	 ...
	 */
    XRegExp.addToken(/\(\?#[^)]*\)/, (match, scope, flags) => {
	 ...
	 */
    XRegExp.addToken(/\s+|#.*/, (match, scope, flags) => {
	    // Keep tokens separated unless the following token is a quantifier
	    return isQuantifierNext(match.input, match.index + match[0].length, flags) ? '' : '(?:)'
    }, { flag: 'x' })
    ...
    XRegExp.addToken(/\\k<([\w$]+)>/, function (match) {
	    // Groups with the same name is an error, else would need `lastIndexOf`
	    let index = isNaN(match[1]) ? indexOf(this.captureNames, match[1]) + 1 : +match[1],
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _match = __webpack_require__(6)

    Object.keys(_match).forEach((key) => {
	  if (key === 'default' || key === '__esModule') return
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
    ...
    const _applyRegexList = __webpack_require__(7)

    Object.keys(_applyRegexList).forEach((key) => {
	  if (key === 'default' || key === '__esModule') return
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _matches = __webpack_require__(8)
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _syntaxhighlighterRegex = __webpack_require__(3)
  ...
  /** */ (function (module, exports) {
    ...
    Renderer.prototype = {
	  ...
	  wrapLine: function wrapLine(lineIndex, lineNumber, lineHtml) {
	    const classes = ['line', `number${lineNumber}`, `index${lineIndex}`, `alt${(lineNumber % 2 == 0 ? 1 : 2).toString()}`]
  ...
  /* 11 */
  /** */ (function (module, exports, __webpack_require__) {
    let trim = __webpack_require__(12),
  ...
  /** */ (function (module, exports) {
    ...
    function findElementsToHighlight(opts) {
	  let elements = getElementsByTagName(opts['tagName']),
	      scripts,
	      i
  ...
  /** */ (function (module, exports, __webpack_require__) {
    /* WEBPACK VAR INJECTION */(function (process) {
      const applyRegexList = __webpack_require__(5).applyRegexList
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _syntaxhighlighterHtmlRenderer = __webpack_require__(9)

    const _syntaxhighlighterHtmlRenderer2 = _interopRequireDefault(_syntaxhighlighterHtmlRenderer)

    const _syntaxhighlighterRegex = __webpack_require__(3)

    const _syntaxhighlighterMatch = __webpack_require__(5)
    ...
    module.exports = (function () {
	  ...
	  _createClass(BrushBase, [{
	    ...
	    value: function getKeywords(str) {
	      const results = str.replace(/^\s+|\s+$/g, '').replace(/\s+/g, '|')
	    ...
	    value: function getHtml(code) {
	      ...
	      const matches = (0, _syntaxhighlighterMatch.applyRegexList)(code, this.regexList)
	      const renderer = new _syntaxhighlighterHtmlRenderer2.default(code, matches, params)
  ...
  /* 23 */
  /** */ (function (module, exports, __webpack_require__) {
    const BrushBase = __webpack_require__(22)
    const regexLib = __webpack_require__(3).commonRegExp
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'after and andalso band begin bnot bor bsl bsr bxor ' + 'case catch cond div end fun if let not of or orelse ' + 'query receive rem try when xor' +
	  // additional
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'as assert break case catch class continue def default do else extends finally ' + 'if in implements import instanceof interface new package property return switch ' + 'throw throws try while public protected private static'
	  const types = 'void boolean byte char short int long float double'
	  const constants = 'null'
	  const methods = 'allProperties count get size ' + 'collect each eachProperty eachPropertyName eachWithIndex find findAll ' + 'findIndexOf grep inject max min reverseEach sort ' + 'asImmutable asSynchronized flatten intersect join pop reverse subMap toList ' + 'padRight padLeft contains eachMatch toCharacter toLong toUrl tokenize ' + 'eachFile eachFileRecurse eachB yte eachLine readBytes readLine getText ' + 'splitEachLine withReader append encodeBase64 decodeBase64 filterLine ' + 'transformChar transformLine withOutputStream withPrintWriter withStream ' + 'withStreams withWriter withWriterAppend write writeLine ' + 'dump inspect invokeMethod print println step times upto use waitForOrKill ' + 'getText'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const flags = ['debug', 'error', 'cpp', 'js', 'neko', 'php', 'flash', 'flash8', 'flash9', 'flash10', 'flash10', 'mobile', 'desktop', 'web', 'ios', 'android', 'iphone']
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  const keywords = 'break case catch class continue ' + 'default delete do else enum export extends false  ' + 'for from as function if implements import in instanceof ' + 'interface let new null package private protected ' + 'static return super switch ' + 'this throw true try typeof var while with yield'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const funcs = 'abs accept alarm atan2 bind binmode chdir chmod chomp chop chown chr ' + 'chroot close closedir connect cos crypt defined delete each endgrent ' + 'endhostent endnetent endprotoent endpwent endservent eof exec exists ' + 'exp fcntl fileno flock fork format formline getc getgrent getgrgid ' + 'getgrnam gethostbyaddr gethostbyname gethostent getlogin getnetbyaddr ' + 'getnetbyname getnetent getpeername getpgrp getppid getpriority ' + 'getprotobyname getprotobynumber getprotoent getpwent getpwnam getpwuid ' + 'getservbyname getservbyport getservent getsockname getsockopt glob ' + 'gmtime grep hex index int ioctl join keys kill lc lcfirst length link ' + 'listen localtime lock log lstat map mkdir msgctl msgget msgrcv msgsnd ' + 'oct open opendir ord pack pipe pop pos print printf prototype push ' + 'quotemeta rand read readdir readline readlink readpipe recv rename ' + 'reset reverse rewinddir rindex rmdir scalar seek seekdir select semctl ' + 'semget semop send setgrent sethostent setnetent setpgrp setpriority ' + 'setprotoent setpwent setservent setsockopt shift shmctl shmget shmread ' + 'shmwrite shutdown sin sleep socket socketpair sort splice split sprintf ' + 'sqrt srand stat study substr symlink syscall sysopen sysread sysseek ' + 'system syswrite tell telldir time times tr truncate uc ucfirst umask ' + 'undef unlink unpack unshift utime values vec wait waitpid warn write ' +
	  // feature
	  'say'

	  const keywords = 'bless caller continue dbmclose dbmopen die do dump else elsif eval exit ' + 'for foreach goto if import last local my next no our package redo ref ' + 'require return sub tie tied unless untie until use wantarray while ' +
	  // feature
	  'given when default ' +
	  // Try::Tiny
	  'try catch finally ' +
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _brushBase = __webpack_require__(22)

    const _brushBase2 = _interopRequireDefault(_brushBase)
    ...
    const functions = 'abs acos acosh addcslashes addslashes ' + 'array_change_key_case array_chunk array_combine array_count_values array_diff ' + 'array_diff_assoc array_diff_key array_diff_uassoc array_diff_ukey array_fill ' + 'array_filter array_flip array_intersect array_intersect_assoc array_intersect_key ' + 'array_intersect_uassoc array_intersect_ukey array_key_exists array_keys array_map ' + 'array_merge array_merge_recursive array_multisort array_pad array_pop array_product ' + 'array_push array_rand array_reduce array_reverse array_search array_shift ' + 'array_slice array_splice array_sum array_udiff array_udiff_assoc ' + 'array_udiff_uassoc array_uintersect array_uintersect_assoc ' + 'array_uintersect_uassoc array_unique array_unshift array_values array_walk ' + 'array_walk_recursive atan atan2 atanh base64_decode base64_encode base_convert ' + 'basename bcadd bccomp bcdiv bcmod bcmul bindec bindtextdomain bzclose bzcompress ' + 'bzdecompress bzerrno bzerror bzerrstr bzflush bzopen bzread bzwrite ceil chdir ' + 'checkdate checkdnsrr chgrp chmod chop chown chr chroot chunk_split class_exists ' + 'closedir closelog copy cos cosh count count_chars date decbin dechex decoct ' + 'deg2rad delete ebcdic2ascii echo empty end ereg ereg_replace eregi eregi_replace error_log ' + 'error_reporting escapeshellarg escapeshellcmd eval exec exit exp explode extension_loaded ' + 'feof fflush fgetc fgetcsv fgets fgetss file_exists file_get_contents file_put_contents ' + 'fileatime filectime filegroup fileinode filemtime fileowner fileperms filesize filetype ' + 'floatval flock floor flush fmod fnmatch fopen fpassthru fprintf fputcsv fputs fread fscanf ' + 'fseek fsockopen fstat ftell ftok getallheaders getcwd getdate getenv gethostbyaddr gethostbyname ' + 'gethostbynamel getimagesize getlastmod getmxrr getmygid getmyinode getmypid getmyuid getopt ' + 'getprotobyname getprotobynumber getrandmax getrusage getservbyname getservbyport gettext ' + 'gettimeofday gettype glob gmdate gmmktime ini_alter ini_get ini_get_all ini_restore ini_set ' + 'interface_exists intval ip2long is_a is_array is_bool is_callable is_dir is_double ' + 'is_executable is_file is_finite is_float is_infinite is_int is_integer is_link is_long ' + 'is_nan is_null is_numeric is_object is_readable is_real is_resource is_scalar is_soap_fault ' + 'is_string is_subclass_of is_uploaded_file is_writable is_writeable mkdir mktime nl2br ' + 'parse_ini_file parse_str parse_url passthru pathinfo print readlink realpath rewind rewinddir rmdir ' + 'round str_ireplace str_pad str_repeat str_replace str_rot13 str_shuffle str_split ' + 'str_word_count strcasecmp strchr strcmp strcoll strcspn strftime strip_tags stripcslashes ' + 'stripos stripslashes stristr strlen strnatcasecmp strnatcmp strncasecmp strncmp strpbrk ' + 'strpos strptime strrchr strrev strripos strrpos strspn strstr strtok strtolower strtotime ' + 'strtoupper strtr strval substr substr_compare'

    const keywords = 'abstract and array as break case catch cfunction class clone const continue declare default die do ' + 'else elseif enddeclare endfor endforeach endif endswitch endwhile extends final finally for foreach ' + 'function global goto if implements include include_once interface instanceof insteadof namespace new ' + 'old_function or private protected public return require require_once static switch ' + 'trait throw try use const while xor yield '

    const constants = '__FILE__ __LINE__ __METHOD__ __FUNCTION__ __CLASS__'

    const Brush = (function (_BrushBase) {
	  ...
	  function Brush() {
	    ...
	    const _this = _possibleConstructorReturn(this, (Brush.__proto__ || Object.getPrototypeOf(Brush)).call(this))
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'while validateset validaterange validatepattern validatelength validatecount ' + 'until trap switch return ref process param parameter in if global: ' + 'function foreach for finally filter end elseif else dynamicparam do default ' + 'continue cmdletbinding break begin alias \\? % #script #private #local #global ' + 'mandatory parametersetname position valuefrompipeline ' + 'valuefrompipelinebypropertyname valuefromremainingarguments helpmessage '

	  const operators = ' and as band bnot bor bxor casesensitive ccontains ceq cge cgt cle ' + 'clike clt cmatch cne cnotcontains cnotlike cnotmatch contains ' + 'creplace eq exact f file ge gt icontains ieq ige igt ile ilike ilt ' + 'imatch ine inotcontains inotlike inotmatch ireplace is isnot le like ' + 'lt match ne not notcontains notlike notmatch or regex replace wildcard'

	  const verbs = 'write where wait use update unregister undo trace test tee take suspend ' + 'stop start split sort skip show set send select scroll resume restore ' + 'restart resolve resize reset rename remove register receive read push ' + 'pop ping out new move measure limit join invoke import group get format ' + 'foreach export expand exit enter enable disconnect disable debug cxnew ' + 'copy convertto convertfrom convert connect complete compare clear ' + 'checkpoint aggregate add'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'and assert break class continue def del elif else ' + 'except exec finally for from global if import in is ' + 'lambda not or pass raise return try yield while'

	  const funcs = '__import__ abs all any apply basestring bin bool buffer callable ' + 'chr classmethod cmp coerce compile complex delattr dict dir ' + 'divmod enumerate eval execfile file filter float format frozenset ' + 'getattr globals hasattr hash help hex id input int intern ' + 'isinstance issubclass iter len list locals long map max min next ' + 'object oct open ord pow print property range raw_input reduce ' + 'reload repr reversed round set setattr slice sorted staticmethod ' + 'str sum super tuple type type unichr unicode vars xrange zip'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'alias and BEGIN begin break case class def define_method defined do each else elsif ' + 'END end ensure false for if in module new next nil not or raise redo rescue retry return ' + 'self super then throw true undef unless until when while yield'

	  const builtins = 'Array Bignum Binding Class Continuation Dir Exception FalseClass File::Stat File Fixnum Fload ' + 'Hash Integer IO MatchData Method Module NilClass Numeric Object Proc Range Regexp String Struct::TMS Symbol ' + 'ThreadGroup Thread Time TrueClass'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'val sealed case def true trait implicit forSome import match object null finally super ' + 'override try lazy for var catch throw type extends class while with new final yield abstract ' + 'else do if return protected private this package false'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  const funcs = 'abs avg case cast coalesce convert count current_timestamp ' + 'current_user day isnull left lower month nullif replace right ' + 'session_user space substring sum system_user upper user year'

	  const keywords = 'absolute action add after alter as asc at authorization begin bigint ' + 'binary bit by cascade char character check checkpoint close collate ' + 'column commit committed connect connection constraint contains continue ' + 'create cube current current_date current_time cursor database date ' + 'deallocate dec decimal declare default delete desc distinct double drop ' + 'dynamic else end end-exec escape except exec execute false fetch first ' + 'float for force foreign forward free from full function global goto grant ' + 'group grouping having hour ignore index inner insensitive insert instead ' + 'int integer intersect into is isolation key last level load local max min ' + 'minute modify move name national nchar next no numeric of off on only ' + 'open option order out output partial password precision prepare primary ' + 'prior privileges procedure public read real references relative repeatable ' + 'restrict return returns revoke rollback rollup rows rule schema scroll ' + 'second section select sequence serializable set size smallint static ' + 'statistics table temp temporary then time timestamp to top transaction ' + 'translation trigger true truncate uncommitted union unique update values ' + 'varchar varying view when where with work'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  ...
	  const keywords = 'as break case class continue default deinit do dynamicType else enum ' + 'extension fallthrough for func if import in init is let new protocol ' + 'return self Self static struct subscript super switch Type typealias ' + 'var where while __COLUMN__ __FILE__ __FUNCTION__ __LINE__ associativity ' + 'didSet get infix inout left mutating none nonmutating operator override ' + 'postfix precedence prefix right set unowned unowned(safe) unowned(unsafe) weak willSet'
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  const keywords = 'break case catch class continue ' + 'default delete do else enum export extends false  ' + 'for function if implements import in instanceof ' + 'interface let new null package private protected ' + 'static return super switch ' + 'this throw true try typeof var while with yield' + ' any bool declare get module never number public readonly set string' // TypeScript-specific, everything above is common with JavaScript
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    function Brush() {
	  const keywords = 'AddHandler AddressOf AndAlso Alias And Ansi As Assembly Auto ' + 'Boolean ByRef Byte ByVal Call Case Catch CBool CByte CChar CDate ' + 'CDec CDbl Char CInt Class CLng CObj Const CShort CSng CStr CType ' + 'Date Decimal Declare Default Delegate Dim DirectCast Do Double Each ' + 'Else ElseIf End Enum Erase Error Event Exit False Finally For Friend ' + 'Function Get GetType GoSub GoTo Handles If Implements Imports In ' + 'Inherits Integer Interface Is Let Lib Like Long Loop Me Mod Module ' + 'MustInherit MustOverride MyBase MyClass Namespace New Next Not Nothing ' + 'NotInheritable NotOverridable Object On Option Optional Or OrElse ' + 'Overloads Overridable Overrides ParamArray Preserve Private Property ' + 'Protected Public RaiseEvent ReadOnly ReDim REM RemoveHandler Resume ' + 'Return Select Set Shadows Shared Short Single Static Step Stop String ' + 'Structure Sub SyncLock Then Throw To True Try TypeOf Unicode Until ' + 'Variant When While With WithEvents WriteOnly Xor'
  ...
  /** */ (function (module, exports) {
    ...
    const string = exports.string = function string(value) {
	  return value.replace(/^([A-Z])/g, (_, character) => {
	    return character.toLowerCase()
	  }).replace(/([A-Z])/g, (_, character) => {
	    return `-${character.toLowerCase()}`
	  })
    }

    const object = exports.object = function object(value) {
	  const result = {}
