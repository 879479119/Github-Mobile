...
import { LOGIN, LOGIN_ERROR, LOGIN_SUCCESS, NETWORK_ERROR, REG, REG_ERROR, REG_SUCCESS, AUTH_FETCH_INFO, AUTH_FETCH_FOLLOWING, AUTH_FETCH_FOLLOWING_READY, AUTH_FETCH_FOLLOWING_ERROR } from '../../../Github-Mobile/aaaaa/layouts/HomeRedux'
import request, { login, register } from '../../../Github-Mobile/aaaaa/utils/request'
...
import { API_AUTH_INFO } from '../../../Github-Mobile/aaaaa/layouts/Home'
