...
export default function trending(state = initialState, action) {
  switch (action.type) {
    case REPO_OR_DEV_FETCH:
      return Object.assign({}, state, { type: action.payload.type, status: 0 })
    case REPO_OR_DEV_LOADING:
      return Object.assign({}, state, { status: 1 })
    case REPO_OR_DEV_READY:
      return Object.assign({}, state, { status: 2, result: action.payload.data })
    case REPO_OR_DEV_ERROR:
      return Object.assign({}, state, { status: 3, result: action.data })
      // filter
    case CHANGE_TREND_SPAN:
      return Object.assign({}, state, { span: action.payload })
    case CHANGE_TREND_LANG:
      return Object.assign({}, state, { language: action.payload })
    case CHANGE_TREND_TYPE:
