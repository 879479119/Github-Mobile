...
export default class SearchResult extends Component {
  componentDidMount() {
    ...
    const value = search.match(/query=([\w%0-9]+)/)[1]
...
function SearchEmpty(props) {
  return (
    <div className="search-empty">
      ...
      <h1>Find what you want <span aria-label="emoji" role="img" className="emoji">😃</span></h1>
...
function SearchShow(props) {
  ...
  const nav = ['Repositories', 'Code', 'Commits', 'Issues', 'Wikis', 'Users']
  const top = nav.map(item => ({
    title: item,
    ...
    >
      ...
      <div className="main-body">
        ...
        <div style={{ textAlign: 'center' }}><Pagination
          ...
          defaultPageSize={30}
          total={result.total_count} onChange={onChange}
        ...
        <Filter
          ...
          sort
          style={{
            position: 'absolute', top: 0, right: 30, boxShadow: 'rgba(0,0,0,0.05) 1px 1px 2px',
          }}
          type="filter"
...
function SearchError(props) {
  return (
    <div className="search-error">
      <img src="/assets/search.svg" alt="" />
      <h1>Something Error When Search <span aria-label="emoji" role="img" className="emoji">😕</span></h1>
      <Search style={{ width: 500 }} onSearch={props.search} />
